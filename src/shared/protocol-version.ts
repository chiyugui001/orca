...
export const GITLAB_MR_DISCUSSION_MUTATIONS_RUNTIME_CAPABILITY =
  'gitlab.mrDiscussionMutations.v1' as const
export const GITLAB_MR_DISCUSSION_MUTATIONS_UPDATE_REQUIRED_MESSAGE =
  'Replying to or deleting merge request comments requires a newer Orca server. Update the server and try again.'
