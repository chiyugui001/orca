...
// Why: feed pinned to the user's fork for self-distributed updates.
const ATOM_FEED_URL = 'https://github.com/chiyugui001/orca-releases/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/chiyugui001/orca-releases/releases/download'
...
const TAG_HREF_RE =
  /href="https:\/\/github\.com\/chiyugui001\/orca-releases\/releases\/tag\/([^"]+)"/g
