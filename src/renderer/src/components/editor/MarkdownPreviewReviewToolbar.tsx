...
export function MarkdownPreviewReviewToolbar({
  ...
  return (
    <>
      <button
        type="button"
        className="inline-flex h-6 shrink-0 items-center justify-center gap-1 rounded-full border border-border/70 bg-muted/40 px-1.5 text-[11px] font-medium leading-none text-foreground/80 hover:bg-accent hover:text-foreground disabled:opacity-50"
