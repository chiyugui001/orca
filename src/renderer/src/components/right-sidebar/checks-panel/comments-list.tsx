      ...
      >
        <div className="flex min-w-0 items-center gap-2">
          ...
          <div className="-mr-1 ml-auto flex items-center gap-0.5">
            {onReplySelectedMRThreads && selectableGroups.length > 0 ? (
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    aria-label="Reply Reviewed to unresolved MR threads"
                    disabled={commentsLoading}
                    onClick={() => onReplySelectedMRThreads(selectableGroups)}
                  >
                    <MessageSquare className="size-3" />
                  </Button>
                </TooltipTrigger>
                <TooltipContent side="top" sideOffset={4}>
                  Reply “Reviewed” to unresolved MR threads
                </TooltipContent>
              </Tooltip>
            ) : null}
            {canShowResolveWithAI && (
