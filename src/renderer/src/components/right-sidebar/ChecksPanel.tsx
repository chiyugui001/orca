...
import { useChecksPanelGitLabCommentMutations } from './checks-panel/use-checks-panel-gitlab-comment-mutations'
...
export default function ChecksPanel(): React.JSX.Element {
  ...
  const gitLabMutationModel = Object.assign(
    mutationModel,
    useChecksPanelGitLabCommentMutations(mutationModel)
  )
  const queueModel = Object.assign(gitLabMutationModel, useChecksPanelAiQueue(gitLabMutationModel))
